...
A Python script that automates the process of playing Cookie Clicker.

 <!-- ![image](https://user-images.githubusercontent.com/17109060/32149040-04f3125c-bd25-11e7-8003-66fd29bc18d4.png) -->

*If you don't know what Cookie Clicker is, have a look at [the game itself](http://www.orteil.dashnet.org/cookieclicker//).*
...
- `keyboard` : A Python module that provides an interface to the keyboard.

- `opencv-python` : A Python module that provides a Python interface for OpenCV for image matching.
...
After running the script, there are several methods to engage the automation.

- `k` : Kill the Python script.

- `a` : Start the Auto Clicker.

- `s` : Stop the Auto Clicker.

- `g` : Start hunting for Golden Cookies.
